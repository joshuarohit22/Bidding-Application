...
compiler_rcc_make_all: qrc_test.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_test.cpp
qrc_test.cpp: test.qrc \
		/usr/lib/qt5/bin/rcc \
		input.txt
	/usr/lib/qt5/bin/rcc -name test test.qrc -o qrc_test.cpp
...
ui_subtree.h: subtree.ui \
		/usr/lib/qt5/bin/uic
	/usr/lib/qt5/bin/uic subtree.ui -o ui_subtree.h

ui_test.h: test.ui \
		/usr/lib/qt5/bin/uic
	/usr/lib/qt5/bin/uic test.ui -o ui_test.h
...
tableinfo.o: tableinfo.cpp tableinfo.h \
		playerinfo.h \
		bounds.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tableinfo.o tableinfo.cpp
...
qrc_test.o: qrc_test.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_test.o qrc_test.cpp
